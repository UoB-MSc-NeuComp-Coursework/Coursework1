...
class BackPropagation:
    ...
    def __init__(self, network_shape=[784, 128, 20, 20, 10]):  # network_shape=(5)[784,128,20,20,10]   (8)[784,20,20,20, 20, 20, 20, 10]
    ...
    def sgd(self,
            batch_size=20,
            epsilon=0.1,
            epochs=150): # manually early stop at certain epochs
        ...
        for t in range(epochs):
            ...
            # print('\n Epochs' + str(t) + '  Test acc: ' + str(test_acc_log[t]) + ' Train acc: ' + str(
            #    train_acc_log[t]) + ' Max Test acc: ' + str(max(test_acc_log)) + ' Max Train acc: ' + str(
            #   max(train_acc_log)))

            for k in range(num_batches):  # tqdm can be  used here to show bar progress
